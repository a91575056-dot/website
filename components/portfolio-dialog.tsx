...
export function PortfolioDialogGrid() {
  const [activeVideo, setActiveVideo] = useState<(typeof portfolioItems)[number] | null>(null);
              ...
              <button className="block w-full text-left" onClick={() => setActiveVideo(item)} type="button">
                <div className="relative overflow-hidden border-b border-white/10">
                  ...
                  <div className="absolute bottom-4 left-4 flex items-center gap-3 text-white">
                    ...
                    <div>
                      <div className="text-xs uppercase tracking-[0.26em] text-white/70">Demo website video</div>
