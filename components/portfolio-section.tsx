...
import portfolioCover from "@/assets/images/image.png";

const LIVE_PORTFOLIO_URL = "https://ephemeral-kangaroo-901767.netlify.app/";

export function PortfolioSection() {
  const locale = useLocale();
  const { portfolio } = getSiteData(locale);
  const featuredItem = portfolio.items[0];
        ...
        <div className="grid gap-8 xl:gap-12">
          ...
          >
            <div className="grid gap-0 xl:grid-cols-[1.08fr_0.92fr]">
              <a href={LIVE_PORTFOLIO_URL} target="_blank" rel="noreferrer" className="group relative block min-h-[320px] overflow-hidden border-b border-stone-300/80 bg-[#0f0f11] xl:min-h-[520px] xl:border-b-0 xl:border-r">
                <Image
                  src={portfolioCover}
              ...
              <div className="flex h-full flex-col px-6 py-6 sm:px-8 sm:py-8">
                ...
                <div className="mt-7">
                  <Button asChild variant="secondary" className="w-full justify-center sm:w-auto sm:min-w-[230px]">
                    <a href={LIVE_PORTFOLIO_URL} target="_blank" rel="noreferrer">
                      {portfolio.openVideoPreview}
